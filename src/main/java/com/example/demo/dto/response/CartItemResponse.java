...
public class CartItemResponse {
    private Long id; private Long variantId; private String productName;
    private String variantInfo; private String productImage; private String productSlug;
    private Integer quantity; private BigDecimal unitPrice; private BigDecimal subtotal;
    private Integer availableStock;

    public CartItemResponse() {}
    public Long getId() { return id; } public void setId(Long id) { this.id = id; }
    public Long getVariantId() { return variantId; } public void setVariantId(Long v) { this.variantId = v; }
    ...
    public String getProductSlug() { return productSlug; } public void setProductSlug(String v) { this.productSlug = v; }
    ...
    public Integer getAvailableStock() { return availableStock; } public void setAvailableStock(Integer v) { this.availableStock = v; }
}
